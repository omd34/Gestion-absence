...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-light">
        <a class="navbar-brand" href="#"><img  class="img-fluid" src="{{asset('enseignant/images/iai.png')}}"  alt="IAI"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item active">
                <a class="nav-link" href="{{ route('home.etudiant')}}">Accueil <span class="sr-only">(current)</span></a>
              </li>   
               ...
               <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="{{ route('declaration.absence')}}">Justifier absence</a>
    ...
    <section class="footer text-center">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 ">
           ...
           Centre D'excellence Technologique Paul Biya<br>
           <br>
      ...
      <div class="copyright text-center">
        Copyright &copy;2024 <span>Gestion des absences</span>
      </div>
     </section>
